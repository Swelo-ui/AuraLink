...
export default function SyncNotes({ connectionId, partner }: { connectionId?: string, partner?: any }) {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-invert prose-sm sm:prose-base focus:outline-none max-w-none px-4 sm:px-8 py-4 sm:py-6 min-h-full selection:bg-aura-primary/30 aura-editor'
      }
    },
    ...
    <div className="flex flex-col h-full bg-aura-navy overflow-visible relative selection:bg-aura-primary/30">
      ...
      <div className="flex-1 overflow-y-auto bg-aura-navy/30 relative no-scrollbar">
        <div className="max-w-4xl mx-auto min-h-full flex flex-col">
          <div className="p-4 sm:p-8 pb-0 animate-in fade-in slide-in-from-top-4 duration-500">
      ...
      <div className="h-9 bg-aura-panel/50 border-t border-aura-border flex items-center justify-between px-4 shrink-0 text-[11px] text-aura-lavender/40 uppercase tracking-[0.15em] font-bold">
